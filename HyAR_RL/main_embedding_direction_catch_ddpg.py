...
def run(args):
    ...
    while total_timesteps < args.max_timesteps:
        ...
        if t % internal == 0 and t >= 1000:
            ...
            # print("recon_s", recon_s)
    print("save txt")
    dir = "result/ddpg/direction_catch"
    data = "0820"
    ...
    title2 = "Reward_100_ddpg_direction_catch_embedding_nopre_relable_"
    title3 = "Test_Reward_ddpg_direction_catch_embedding_nopre_relable_"
    title4 = "Test_success_ddpg_direction_catch_embedding_nopre_relable_"
