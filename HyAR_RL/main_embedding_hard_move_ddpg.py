...
def run(args):
    ...
    while total_timesteps < args.max_timesteps:
        ...
        if t % internal == 0 and t >= 1000:
            ...
            # print("recon_s", recon_s)
    print("save txt")
    dir = "result/ddpg/simple_move_4_direction_v1"
    data = "0820"
    ...
    title1 = "Reward_ddpg_simple_move_4_direction_v1_embedding_nopre_relable_"+"{}".format(args.action_n_dim)+"_"
    title2 = "Reward_100_ddpg_simple_move_4_direction_v1_embedding_nopre_relable_"+"{}".format(args.action_n_dim)+"_"
    title3 = "Test_Reward_ddpg_simple_move_4_direction_v1_embedding_nopre_relable_"+"{}".format(args.action_n_dim)+"_"
    title4 = "Test_success_ddpg_simple_move_4_direction_v1_embedding_nopre_relable_"+"{}".format(args.action_n_dim)+"_"
    title5 = "Test_epioside_step_ddpg_simple_move_4_direction_v1_embedding_nopre_relable_"+"{}".format(args.action_n_dim)+"_"
